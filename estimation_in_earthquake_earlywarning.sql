...
--
-- Host: localhost
-- Generation Time: Aud 24, 2022 at 07:36 AM
...
--
-- Database: `estimation_in_earthquake_earlywarning`
--
CREATE DATABASE IF NOT EXISTS `estimation_in_earthquake_earlywarning` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `estimation_in_earthquake_earlywarning`;
...
(1, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Malleshwaram', 'Male'),
...
(13, 'Naive Bayes', '90.23150762281198'),
(14, 'SVM', '92.65951439864483'),
(15, 'Logistic Regression', '92.37718802936195'),
(16, 'Decision Tree Classifier', '92.88537549407114'),
(17, 'KNeighborsClassifier', '90.6832298136646'),
(18, 'Random Forest Classifier', '93.16770186335404');
...
(8, 'Earthquake Warning', '50.0'),
(9, 'Explosion Warning', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_earthquake_early_warning_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_earthquake_early_warning_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ewtime` varchar(3000) NOT NULL,
  `latitude` varchar(3000) NOT NULL,
  `longitude` varchar(3000) NOT NULL,
  `depth` varchar(3000) NOT NULL,
  `mag` varchar(3000) NOT NULL,
  `magType` varchar(3000) NOT NULL,
  `nst` varchar(3000) NOT NULL,
  `gap` varchar(3000) NOT NULL,
  `dmin` varchar(3000) NOT NULL,
  `rms` varchar(3000) NOT NULL,
  `net` varchar(3000) NOT NULL,
  `idn` varchar(3000) NOT NULL,
  `updated` varchar(3000) NOT NULL,
  `place` varchar(3000) NOT NULL,
  `horizontalError` varchar(3000) NOT NULL,
  `depthError` varchar(3000) NOT NULL,
  `magError` varchar(3000) NOT NULL,
  `magNst` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_earthquake_early_warning_prediction`
--

INSERT INTO `remote_user_earthquake_early_warning_prediction` (`id`, `ewtime`, `latitude`, `longitude`, `depth`, `mag`, `magType`, `nst`, `gap`, `dmin`, `rms`, `net`, `idn`, `updated`, `place`, `horizontalError`, `depthError`, `magError`, `magNst`, `Prediction`) VALUES
(1, '2022-08-23T02:02:56.400Z', '19.18916702', '-155.5106659', '35.77999878', '2.2', 'ml', '47', '90', 'NA', '0.109999999', 'hv', 'hv73118182', '2022-08-23T02:08:26.150Z', '3 km WSW of PÄhala, Hawaii', '0.48', '0.870000005', '4.24', '10', 'Explosion Warning'),
(2, '2022-08-23T00:35:27.226Z', '-52.5504', '-71.7165', '35.032', '4.2', 'mb', '26', '150', '0.32', '0.72', 'us', 'us6000icx6', '2022-08-23T00:54:07.622Z', '86 km NW of Punta Arenas, Chile', '5.91', '8.936', '0.128', '17', 'Explosion Warning'),
(3, '2022-08-22T22:27:15.485Z', '58.4812', '-154.8813', '10', '1', 'ml', 'NA', 'NA', 'NA', '1.04', 'ak', 'ak022ard0ke4', '2022-08-23T00:39:50.510Z', '104 km NNW of Karluk, Alaska', 'NA', '1', 'NA', 'NA', 'Earthquake Warning'),
(4, '2022-08-22T20:37:34.420Z', '38.8326683', '-122.8191681', '1.38', '0.83', 'md', '21', '57', '0.01167', '0.05', 'nc', 'nc73770790', '2022-08-22T20:50:11.357Z', '8km NW of The Geysers, CA\r\n', '0.22', '0.41', '0.24', '4', 'Earthquake Warning'),
(5, '2022-08-20T21:32:07.560Z', '19.19400024', '-155.3846741', '32.52999878', '2.22000003', 'md', '37', '172', 'NA', '0.129999995', 'hv', 'hv73115897', '2022-08-20T21:35:22.830Z', '9 km E of PÄhala, Hawaii', '0.72', '0.860000014', '1.32000005', '11', 'Explosion Warning'),
(6, '2022-08-20T16:07:41.633Z', '65.162', '-149.0029', '8.3', '0.9', 'ml', 'NA', 'NA', 'NA', '0.75', 'ak', 'ak022any91e2', '2022-08-20T16:10:45.349Z', '16 km E of Minto, Alaska\r\n', 'NA', '0.3', 'NA', 'NA', 'Earthquake Warning');
